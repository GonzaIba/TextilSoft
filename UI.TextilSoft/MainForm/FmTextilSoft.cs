    ...
    public partial class FmTextilSoft : Form
    {
        ...
        private void FmTextilSoft_Load(object sender, EventArgs e)
        {
            try
            {
                timer1.Start();
                timer2.Start();
                //lblBienvenido.ForeColor = Color.FromArgb(this.BackColor.R, this.BackColor.G, this.BackColor.B);

                //foreach (Control controlForm in this.Controls)
                //{
                //    if(controlForm is Panel)
                //    {
                //        foreach(Control panel in controlForm.Controls)
                //        {
                //            MessageBox.Show("Hola=?? soy un crack");
                //        }
                //    }
                //}
                ...
                //panel1.GetControls<DataGridView>();

                //panel1.GetControls<Button>();
                //panel1.GetControls<IconButton>();


                //--------- Forma 1 de obtener los controles... problemas con paneles---------------------
        ...
        private void AbrirAnimator(object abrirContenedor)
        {
        ...
        private void btnPedidos_Click(object sender, EventArgs e)
        {
            ...
            AbrirFormHija(new FmPedidos(_pedidosController,_clientesController));
