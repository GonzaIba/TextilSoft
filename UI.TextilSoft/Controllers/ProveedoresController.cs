...
namespace UI.TextilSoft.Controllers
{
    public class ProveedoresController : IProveedoresController
    {
        ...
        public ProveedoresController(IProveedoresService proveedoresService, IMapper mapper)
        {
        ...
        {
            var ProveedorDTO = _proveedoresService.Get(x => x.DNI == proveedoresEntity.DNI).FirstOrDefault();
        ...
        public ProveedoresEntity ObtenerProveedor(int DNI)
        {
