...
namespace SL.Infrastructure.Migrations
{
    ...
    [Migration("20230319145535_ALTER_TABLE_LOGS")]
    partial class ALTER_TABLE_LOGS
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SL.Domain.Model.CompanySendGridConfigModel", b =>
                {
                    b.Property<int>("CompanySendGridConfigId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.HasKey("CompanySendGridConfigId");
            ...
            modelBuilder.Entity("SL.Domain.Model.CompanySendGridConfigModel", b =>
                {
                    b.HasOne("SL.Domain.Model.CompanyModel", "Company")
                        .WithOne("CompanySendGridConfig")
                        .HasForeignKey("SL.Domain.Model.CompanySendGridConfigModel", "CompanyId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
